...
Approach: Model rooms as graph nodes and keys as directed edges. Starting from node 0, traverse all reachable nodes. If every node is reachable, return True.
